...
* As we can see, non-diabetic patients will have a tall peak where the majority of patients will fall into that bin depending on the variables
  ...
  * For example: majority of non-diabetic patients will have 0-1 pregnancies as shown by the tall peak! But the majority of diabetic patients may have 1-8 pregnancies!
 
  * Majority of non-diabetic patients will have a glucose level of 100 as shown by the tall peak. But the majority of diabetic patients may have a glucose level of 125-175!
...
* Variables with statistically significant variability (< 5%), but are not as strong of predictors as the top 3) have overlapping density plots (with slight rightward shifts) and similar wideness in density (slightly wider)

* Although the diabetes pedigree function and blood pressure are slightly different, it is still statistically significant as shown by our linear regression model
